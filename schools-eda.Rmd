...
I also noticed a few more items I would like to clean up. First, I would like to mutate the `time_period` column so that it displays only the start year of the academic year (i.e. '202021' becomes '2020'. We can also rename it to `year_of_entry` for clarity).
